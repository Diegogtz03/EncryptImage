...
# Pedir al usuario la ruta de la imagen y el tamaño de la llave a utilizar, y validar que sean correctos
imagen = input("Ingrese direccion de la imagen: ")

# Validar que la ruta de la imagen ingresada sea correcta
while (not validateImage(imagen)):
  imagen = input("Ingrese direccion de la imagen: ")

llave = input("Ingrese tamaño de llave (0-256): ")

# Validar que la llave ingresada sea correcta
...
# Recorrer el arreglo y encriptar cada uno de los bytes con la llave dada 
# (elevando el contenido de cada byte a la potencia de la llave)
